...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('img', { src: "../static/images/cards/" + this.props.cardNumber + ".png", className: this.props.side + "_card" + this.props.handPosition });
	    }
	});

	var Hand_Score = React.createClass({
	    displayName: 'Hand_Score',


	    render: function render() {
	        return React.createElement(
	            'span',
	            { className: 'neongreen smallertext' },
	            this.props.score
	        );
	    }
	});
	...
	var Chip_Hand = React.createClass({
	    displayName: 'Chip_Hand',


	    render: function render() {
	        return React.createElement('img', { src: "../static/images/chips/chip" + this.props.chipNumber + ".png", className: this.props.side + "_chip" + this.props.position });
	    }
	});

	var Chip_Bet = React.createClass({
	    displayName: 'Chip_Bet',


	    render: function render() {
	        return React.createElement('img', { src: "../static/images/chips/chip" + this.props.chipNumber + ".png", className: "chip" + this.props.chipNumber });
	    }
	});
	...
	var Win = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'p',
	            { className: 'neongreen smallertext' },
	            this.props.win_amount
	        );
	    }
	});

	var total_bank = ReactDOM.render(React.createElement(Bank, { bank: '$2000' }), document.getElementById('total_bank'));
	var total_bet = ReactDOM.render(React.createElement(Bet_Total, { total_bet: '$500' }), document.getElementById('total_bet'));
	var total_bank = ReactDOM.render(React.createElement(Win, { win_amount: '$1000' }), document.getElementById('total_win'));
	...
	var left_bust = ReactDOM.render(React.createElement(Busted, { visible: 'show' }), document.getElementById('left_bust'));
	var mid_bust = ReactDOM.render(React.createElement(Busted, { visible: 'show' }), document.getElementById('mid_bust'));
	var right_bust = ReactDOM.render(React.createElement(Busted, { visible: 'show' }), document.getElementById('right_bust'));

	var left_held = ReactDOM.render(React.createElement(Held, { visible: 'show' }), document.getElementById('left_held'));
	var mid_held = ReactDOM.render(React.createElement(Held, { visible: 'show' }), document.getElementById('mid_held'));
	var right_held = ReactDOM.render(React.createElement(Held, { visible: 'show' }), document.getElementById('right_held'));

	var dealer_score = ReactDOM.render(React.createElement(Hand_Score, { score: '??' }), document.getElementById('dealer_score'));

	var left_score = ReactDOM.render(React.createElement(Hand_Score, { score: '21' }), document.getElementById('left_score'));
	var mid_score = ReactDOM.render(React.createElement(Hand_Score, { score: '21' }), document.getElementById('mid_score'));
	var right_score = ReactDOM.render(React.createElement(Hand_Score, { score: '21' }), document.getElementById('right_score'));

	var left_bet = ReactDOM.render(React.createElement(Hand_Bet, { bet: '$1000' }), document.getElementById('left_bet'));
	var mid_bet = ReactDOM.render(React.createElement(Hand_Bet, { bet: '$1000' }), document.getElementById('mid_bet'));
	var right_bet = ReactDOM.render(React.createElement(Hand_Bet, { bet: '$1000' }), document.getElementById('right_bet'));

	var left_chip1 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '1' }), document.getElementById('left_chip1'));
	var left_chip2 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '2' }), document.getElementById('left_chip2'));
	var left_chip3 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '3' }), document.getElementById('left_chip3'));
	var left_chip4 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '4' }), document.getElementById('left_chip4'));
	var left_chip5 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '5' }), document.getElementById('left_chip5'));
	var left_chip6 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '6' }), document.getElementById('left_chip6'));
	var left_chip7 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '7' }), document.getElementById('left_chip7'));
	var left_chip8 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'left', position: '8' }), document.getElementById('left_chip8'));

	var mid_chip1 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '1' }), document.getElementById('mid_chip1'));
	var mid_chip2 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '2' }), document.getElementById('mid_chip2'));
	var mid_chip3 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '3' }), document.getElementById('mid_chip3'));
	var mid_chip4 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '4' }), document.getElementById('mid_chip4'));
	var mid_chip5 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '5' }), document.getElementById('mid_chip5'));
	var mid_chip6 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '6' }), document.getElementById('mid_chip6'));
	var mid_chip7 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '7' }), document.getElementById('mid_chip7'));
	var mid_chip8 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'mid', position: '8' }), document.getElementById('mid_chip8'));

	var right_chip1 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '1' }), document.getElementById('right_chip1'));
	var right_chip2 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '2' }), document.getElementById('right_chip2'));
	var right_chip3 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '3' }), document.getElementById('right_chip3'));
	var right_chip4 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '4' }), document.getElementById('right_chip4'));
	var right_chip5 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '5' }), document.getElementById('right_chip5'));
	var right_chip6 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '6' }), document.getElementById('right_chip6'));
	var right_chip7 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '7' }), document.getElementById('right_chip7'));
	var right_chip8 = ReactDOM.render(React.createElement(Chip_Hand, { chipNumber: '100', side: 'right', position: '8' }), document.getElementById('right_chip8'));
